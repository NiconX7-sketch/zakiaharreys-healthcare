// ============================================
// MAIN JAVASCRIPT - OPTIMIZED FOR FAST LOADING
// ============================================
...
function loadAllData() {
    ...
    Promise.all([
        ...
        window.supabase.from('blog_posts').select('*').eq('published', true).order('created_at', { ascending: false }).limit(3)
...
function displayLatestPosts() {
    ...
    container.innerHTML = allBlogs.map(post => {
        ...
        return `
            <div class="blog-card">
                ...
                <div class="blog-content">
                    ...
                    <p class="blog-meta"><i class="far fa-calendar-alt"></i> ${date}</p>
